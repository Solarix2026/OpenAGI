...
# Manual (Unix/Mac)
pip install -r requirements.txt  # or see setup.bat for full dependency list
cp .env.example .env
...
```bash
# Quick test suite (10 core tests)
python run_tests.py

# Full test with L4 verification and comprehensive checks
...
python run_tests.py  # then look for [PASS]/[FAIL]
```
